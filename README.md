...
```bash
github-actions-with-aws-sam$ sam local invoke NetCodeWebAPIServerless --event events/event.json
```
...
```bash
github-actions-with-aws-sam$ sam build
github-actions-with-aws-sam$ sam deploy
```
...
```bash
github-actions-with-aws-sam$ sam logs -n NetCodeWebAPIServerless --stack-name github-actions-with-aws-sam --tail
```
...
```bash
github-actions-with-aws-sam$ dotnet test test/ServerlessAPI.Tests/ServerlessAPI.Tests.csproj 
```
